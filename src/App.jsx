...
const STEPS = [
  {
    n: '1',
    group: 'Stažení projektu',
    title: 'Otevři odkaz na Google Drive a stáhni složku',
    body: 'Klikni na odkaz na Google Drive, který jsi od nás dostal. Otevře se ti složka s projektem. Vpravo nahoře klikni na ikonu tří teček nebo přímo na „Stáhnout" — Google Drive složku zabalí do ZIP souboru a začne stahování.',
    tip: 'Stahování může chvíli trvat — složka má pár set MB. Soubor se uloží do tvé složky „Stažené soubory" (Downloads).',
  },
  {
    n: '2',
    group: 'Stažení projektu',
    title: 'Rozbal stažený ZIP soubor',
    body: 'Najdi stažený ZIP soubor (bude se jmenovat něco jako „valor-group.zip") ve složce Stažené soubory. Klikni na něj pravým tlačítkem a vyber „Rozbalit vše" (Windows) nebo „Otevřít" (Mac). Složka valor-group se rozbalí vedle ZIP souboru.',
    tip: 'Rozbalenou složku valor-group si přesuň na místo, kde ji budeš mít po ruce — třeba na Plochu nebo do Dokumentů.',
  },
  {
    n: '3',
    group: 'Stažení projektu',
    title: 'Smaž ZIP soubor — už ho nepotřebuješ',
    body: 'ZIP soubor po rozbalení nemá žádné využití. Klikni na něj pravým tlačítkem, vyber „Odstranit" (nebo přesuň do Koše) a Koš vyprázdni. Ušetříš si místo na disku.',
    tip: 'Pracovní složka je ta rozbalená „valor-group" — ZIP je jen obal pro přenos.',
  },
  {
    n: '4',
    group: 'Příprava',
  ...
  },
  {
    ...
    tip: 'Pokud složku „valor-group” v seznamu Workspaces už vidíš (z minula), můžeš na ni rovnou kliknout a přeskočit kroky 7–9.',
  },
  {
    n: '8',
    group: 'Otevření Agent Manageru',
  ...
  },
  {
    ...
    body: 'V okénku najdi složku valor-group (tu rozbalenou z kroku 2). Klikni na ni jednou, aby byla označená, a klikni dole na tlačítko „Open” nebo „Select Folder”. Složka se přidá do seznamu Workspaces vlevo.',
